...
import Image from "next/image"; // ✅ FIX ADDED
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const sidebarLinks = [
    ...
    { href: "/dashboard/assignment", label: "Assignment", icon: FileEdit },
    { href: "/dashboard/student/progress", label: "Progress", icon: BarChart3 },
    { href: "/dashboard/student/message", label: "Message", icon: MessageSquare },
    { href: "/dashboard/student/fee-management", label: "Fee-Management", icon: CreditCard },
    { href: "/dashboard/student/setting", label: "Settings", icon: Settings },
  ];
    ...
    <div className="flex h-screen bg-[#F8F9FD]">
      ...
      >
        ...
        <nav className="flex-1 px-4 py-4 space-y-1">
          <p className="text-[10px] uppercase font-bold text-gray-500 px-2 mb-2 tracking-widest">
            Menu
          </p>
        ...
        <div className="m-4 p-4 bg-[#2B2B3D] rounded-2xl">
          ...
          <p className="text-[10px] text-gray-400 mt-1">
            Reach out to your academic advisor anytime.
          </p>
